...
enum ApiProto_VpnReqMsgType: SwiftProtobuf.Enum {
  ...
  case getEvents // = 4
  case initUpdate // = 5
  case checkForUpdate // = 6
  case applyUpdateWithRestart // = 7
  case destroyService // = 8
  ...
  init?(rawValue: Int) {
    ...
    case 5: self = .initUpdate
    case 6: self = .checkForUpdate
    case 7: self = .applyUpdateWithRestart
    case 8: self = .destroyService
    default: return nil
    }
  }
  ...
  var rawValue: Int {
    ...
    case .initUpdate: return 5
    case .checkForUpdate: return 6
    case .applyUpdateWithRestart: return 7
    case .destroyService: return 8
    }
  }
...
enum ApiProto_EventID: SwiftProtobuf.Enum {
  ...
  init() {
    self = .eventUpdateReady
  }

  init?(rawValue: Int) {
    switch rawValue {
    case -1: self = .unknown
    case 1: self = .eventUpdateReady
  ...
  var rawValue: Int {
    ...
    case .eventUpdateReady: return 1
...
struct ApiProto_VpnReqMsg {
  ...
  var initUpdate: ApiProto_InitUpdateReq {
    get {
      if case .initUpdate(let v)? = data {return v}
      return ApiProto_InitUpdateReq()
    }
    set {data = .initUpdate(newValue)}
  }

  var applyUpdate: ApiProto_ApplyUpdateWithRestartReq {
    get {
      if case .applyUpdate(let v)? = data {return v}
      return ApiProto_ApplyUpdateWithRestartReq()
    }
    set {data = .applyUpdate(newValue)}
  }
  ...
  enum OneOf_Data: Equatable {
    ...
    case initUpdate(ApiProto_InitUpdateReq)
    case applyUpdate(ApiProto_ApplyUpdateWithRestartReq)
    ...
    static func ==(lhs: ApiProto_VpnReqMsg.OneOf_Data, rhs: ApiProto_VpnReqMsg.OneOf_Data) -> Bool {
      ...
      case (.initUpdate(let l), .initUpdate(let r)): return l == r
      case (.applyUpdate(let l), .applyUpdate(let r)): return l == r
...
struct ApiProto_EventData {
  ...
  var evID: ApiProto_EventID {
    get {return _evID ?? .eventUpdateReady}
    set {_evID = newValue}
  }
  ...
  var updateReadyData: ApiProto_UpdateReadyData {
    get {
      if case .updateReadyData(let v)? = data {return v}
      return ApiProto_UpdateReadyData()
    }
    set {data = .updateReadyData(newValue)}
  }
  ...
  enum OneOf_Data: Equatable {
    ...
    case updateReadyData(ApiProto_UpdateReadyData)
    ...
    static func ==(lhs: ApiProto_EventData.OneOf_Data, rhs: ApiProto_EventData.OneOf_Data) -> Bool {
      ...
      case (.updateReadyData(let l), .updateReadyData(let r)): return l == r
      default: return false
      }
    }
  #endif
...
struct ApiProto_VpnConnectInfo {
  ...
  /// Returns true if `ip4` has been explicitly set.
  var hasIp4: Bool {return self._ip4 != nil}
  /// Clears the value of `ip4`. Subsequent reads from it will return its default value.
  mutating func clearIp4() {self._ip4 = nil}
  ...
  fileprivate var _ip4: UInt32? = nil
  fileprivate var _serverIp: String? = nil
  fileprivate var _bitrateTx: UInt64? = nil
  fileprivate var _bitrateRx: UInt64? = nil
  fileprivate var _traffic: UInt64? = nil
  fileprivate var _memoryFootprint: UInt64? = nil
}

struct ApiProto_UpdateReadyData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct ApiProto_InitUpdateReq {
  ...
  fileprivate var _checkInterval: UInt32? = nil
}

struct ApiProto_ApplyUpdateWithRestartReq {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ApiProto_VpnReqMsgType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .same(proto: "InitUpdate"),
    6: .same(proto: "CheckForUpdate"),
    7: .same(proto: "ApplyUpdateWithRestart"),
    8: .same(proto: "DestroyService"),
  ]
}
...
extension ApiProto_EventID: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    1: .same(proto: "EVENT_UPDATE_READY"),
...
extension ApiProto_VpnReqMsg: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "initUpdate"),
    4: .same(proto: "applyUpdate"),
  ]

  public var isInitialized: Bool {
    if self._type == nil {return false}
    switch self.data {
    case .startVpnData(let v)?: if !v.isInitialized {return false}
    case .initUpdate(let v)?: if !v.isInitialized {return false}
    case .applyUpdate(let v)?: if !v.isInitialized {return false}
    default: break
    }
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3:
        var v: ApiProto_InitUpdateReq?
        if let current = self.data {
          try decoder.handleConflictingOneOf()
          if case .initUpdate(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.data = .initUpdate(v)}
      case 4:
        var v: ApiProto_ApplyUpdateWithRestartReq?
        if let current = self.data {
          try decoder.handleConflictingOneOf()
          if case .applyUpdate(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.data = .applyUpdate(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.data {
    case .startVpnData(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    case .initUpdate(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    case .applyUpdate(let v)?:
...
extension ApiProto_EventData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9:
        var v: ApiProto_UpdateReadyData?
        if let current = self.data {
          try decoder.handleConflictingOneOf()
          if case .updateReadyData(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.data = .updateReadyData(v)}
      default: break
      }
    }
  }
...
extension ApiProto_VpnConnectInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "ip"),
    2: .same(proto: "ip4"),
    3: .standard(proto: "server_ip"),
    4: .same(proto: "bitrateTx"),
    5: .same(proto: "bitrateRx"),
    6: .same(proto: "traffic"),
    7: .standard(proto: "memory_footprint"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt32Field(value: &self._ip4)
      case 3: try decoder.decodeSingularStringField(value: &self._serverIp)
      case 4: try decoder.decodeSingularUInt64Field(value: &self._bitrateTx)
      case 5: try decoder.decodeSingularUInt64Field(value: &self._bitrateRx)
      case 6: try decoder.decodeSingularUInt64Field(value: &self._traffic)
      case 7: try decoder.decodeSingularUInt64Field(value: &self._memoryFootprint)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: ApiProto_VpnConnectInfo, rhs: ApiProto_VpnConnectInfo) -> Bool {
    ...
    if lhs._ip4 != rhs._ip4 {return false}
...
extension ApiProto_UpdateReadyData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UpdateReadyData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "desc"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._desc)
  ...
  static func ==(lhs: ApiProto_UpdateReadyData, rhs: ApiProto_UpdateReadyData) -> Bool {
...
extension ApiProto_InitUpdateReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".InitUpdateReq"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "host"),
    2: .same(proto: "path"),
    3: .standard(proto: "check_interval"),
  ]

  public var isInitialized: Bool {
    if self._host == nil {return false}
    if self._path == nil {return false}
    if self._checkInterval == nil {return false}
    return true
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._host)
      case 2: try decoder.decodeSingularStringField(value: &self._path)
      case 3: try decoder.decodeSingularUInt32Field(value: &self._checkInterval)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: ApiProto_InitUpdateReq, rhs: ApiProto_InitUpdateReq) -> Bool {
...
extension ApiProto_ApplyUpdateWithRestartReq: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ApplyUpdateWithRestartReq"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "path"),
  ]
  ...
  static func ==(lhs: ApiProto_ApplyUpdateWithRestartReq, rhs: ApiProto_ApplyUpdateWithRestartReq) -> Bool {
    if lhs._path != rhs._path {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
