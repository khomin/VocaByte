...
class PageWordDetailsState extends State<PageWordDetails>
  ...
  void initState() {
    ...
    _playWordCtr = AnimationController(
      vsync: this,
      duration: Constants.animDurationFast,
    );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: _footerButtons(),
        ));
  }
      ...
      return SliverList.builder(
          ...
          itemBuilder: (context, index) {
            ...
            var textSpan = UiHelper.makeTextSpan(
                ...
                text: i ?? '',
                colorBase: Theme.of(context).colorScheme.appBarText.color!,
                colorHighlight: Theme.of(context).colorScheme.buttonOption2);
            return Container(
              decoration: BoxDecoration(
